...
def alexnet(parameters):
    """A Alexnet model used for demonstration and tests"""
    net_input = Input([32, 32, 3])

    output = Conv2D(96,(11,11),strides=(1,1),padding='valid',activation='relu',kernel_initializer='uniform')(net_input)
    output = MaxPooling2D(pool_size=(3,3),strides=(2,2))(output)
    
    output = Conv2D(256,(5,5),strides=(1,1),padding='same',activation='relu',kernel_initializer='uniform')(output)
    output = MaxPooling2D(pool_size=(3,3),strides=(2,2))(output)
    output = Conv2D(384,(3,3),strides=(1,1),padding='same',activation='relu',kernel_initializer='uniform')(output)
    output = Conv2D(384,(3,3),strides=(1,1),padding='same',activation='relu',kernel_initializer='uniform')(output)
    output = Conv2D(256,(3,3),strides=(1,1),padding='same',activation='relu',kernel_initializer='uniform')(output)
    output = MaxPooling2D(pool_size=(3,3),strides=(2,2))(output)
    output = Flatten(name='flatten')(output)
    output = Dense(4096,activation='relu')(output)
    output = Dropout(0.5)(output)
    output = Dense(4096,activation='relu')(output)
    ouptut = Dropout(0.5)(output)
    output = Dense(200,activation='softmax')(output)
...
def mymodel2(parameters):
    """A Alexnet model used for demonstration and tests"""
    net_input = Input([64, 64, 3])

    #--------------------------
    output = Conv2D(4, kernel_size=(3, 3), activation='relu')(net_input)
    output = Conv2D(8, (3, 3), activation='relu')(output)
